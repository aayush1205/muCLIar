...
class Search():
    ...
    def search(self):
        ...
        try:
            ...
            info = driver.find_element_by_xpath(r'//*[@id="container"]/h1/yt-formatted-string').text
            print(Fore.LIGHTRED_EX + f"Now Playing: {Fore.LIGHTCYAN_EX + str(info)}")

            try:

                while True:

                    info2 = driver.find_element_by_xpath(r'//*[@id="container"]/h1/yt-formatted-string').text
                    if(info2 != info):
                ...
                display.stop()
                print("\n")
                val = input(Fore.LIGHTRED_EX + "New song or quit? (enter n or q): ")
